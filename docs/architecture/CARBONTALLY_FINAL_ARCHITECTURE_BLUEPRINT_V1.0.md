...
These roles are distinct from CarbonTally internal staff roles.
...
PE operational messaging, if implemented, is:

```text
PE ↔ CarbonTally Operations
```

and must be entity-scoped.
...
or unrestricted cross-PE communication.
