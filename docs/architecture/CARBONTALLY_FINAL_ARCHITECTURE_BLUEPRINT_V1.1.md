# CarbonTally Final Architecture Blueprint v1.0
...
PE QC does not constitute customer approval.
...
- PE extraction/mapping/validation/QC actions are authorized.
...
The following decisions were approved after the original v1.0 freeze candidate was reviewed and are now incorporated into v1.1.
...
**CARBONTALLY FINAL ARCHITECTURE BLUEPRINT v1.1**

It is the architectural source of truth.

Version 1.1 incorporates the following frozen Product Owner decisions approved on 2 September 2026:
