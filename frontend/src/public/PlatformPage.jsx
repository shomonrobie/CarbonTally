...
import ProcessingWorkbenchDemo from './demos/ProcessingWorkbenchDemo';
...
export default function PlatformPage() {
  return (
    ...
    >
      ...
      {/* PROCESSING WORKBENCH (D19) */}
      <section className="ct-section">
        <div className="ct-container">
          <div className="ct-section-head center">
            <h2>The processing workbench</h2>
            <p>
              Source and structured data side by side, with a top workflow navigation —
              Queue → Extract → Map → Validate → Review → QC → Evidence. On mobile the
              panes become a tray (Source ⇄ Data), never a squeezed split.
            </p>
          </div>
          <ProcessingWorkbenchDemo />
        </div>
      </section>
      ...
      <section className="ct-section ct-section-alt">
        <div className="ct-container">
          <div className="ct-section-head center">
            <h2>Reporting — a structured, evidence-backed report</h2>
            <p>
              Reports combine the verified data with scope and category summaries, source
              information, calculation snapshots and evidence status — then export as
              structured data or a branded PDF.
            </p>
          </div>
          <ReportingDemo />
        </div>
