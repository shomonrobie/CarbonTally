...
export const WORK_ITEM_DIESEL = workItem({
  id: 'w-aurora-1',
  batch: 'B-1042',
...
export const WORKSPACES = [
  {
    ...
    masterData: {
      facilities: [
        { name: 'Birmingham Hub', type: 'Processing & storage', status: 'active' },
        { name: 'Leeds Mill', type: 'Manufacturing', status: 'active' },
        { name: 'Glasgow Depot', type: 'Warehouse', status: 'remediation' },
      ],
      assets: [
        { name: 'Forklift fleet (4)', type: 'Material handling', facility: 'Birmingham Hub' },
        { name: 'CHP unit', type: 'Combined heat & power', facility: 'Leeds Mill' },
        { name: 'Delivery vans (6)', type: 'Fleet', facility: 'Glasgow Depot' },
        { name: 'Cold store', type: 'Refrigeration', facility: 'Birmingham Hub' },
      ],
      suppliers: [
        { name: 'Meridian Fuel Supplies Ltd', category: 'Fuel', status: 'verified' },
        { name: 'Scottish Power Energy Retail', category: 'Utilities', status: 'verified' },
        { name: 'Waste Clear Ltd', category: 'Waste', status: 'pending' },
      ],
      customFactors: [
        { name: 'Supplier-specific electricity', activity: 'Electricity', status: 'active' },
        { name: 'Delivery van diesel (own fleet)', activity: 'Diesel (road)', status: 'draft' },
      ],
    },
  },
  {
    ...
    masterData: {
      facilities: [
        { name: 'Leeds Mill', type: 'Manufacturing', status: 'active' },
        { name: 'Manchester Studio', type: 'Design studio', status: 'active' },
      ],
      assets: [
        { name: 'Dyeing machinery', type: 'Manufacturing', facility: 'Leeds Mill' },
        { name: 'Fleet van', type: 'Fleet', facility: 'Manchester Studio' },
      ],
      suppliers: [
        { name: 'Scottish Power Energy Retail', category: 'Utilities', status: 'verified' },
        { name: 'DyeChem Ltd', category: 'Chemicals', status: 'verified' },
      ],
      customFactors: [
        { name: 'Supplier-specific electricity', activity: 'Electricity', status: 'active' },
      ],
  ...
  },
  {
    ...
    masterData: {
      facilities: [
        { name: 'Nottingham Depot', type: 'Depot', status: 'active' },
        { name: 'Birmingham Yard', type: 'Yard', status: 'active' },
      ],
      assets: [
        { name: 'HGV fleet (12)', type: 'Fleet', facility: 'Nottingham Depot' },
        { name: 'Van fleet (8)', type: 'Fleet', facility: 'Birmingham Yard' },
      ],
      suppliers: [
        { name: 'FleetCard Ltd', category: 'Fuel cards', status: 'verified' },
      ],
      customFactors: [],
    },
  },
