...
export default function PricingPage() {
  return (
    <PageShell
      ...
      description="Planned CarbonTally pricing: Starter, Professional, Business and Enterprise plans with a credit-based processing model. Pricing is subject to final commercial terms."
    >
      ...
      <section className="ct-section">
        <div className="ct-container">
          ...
          <p className="ct-note" style={{ marginTop: 24 }}>
            Plan pricing shown here is planned pricing and is subject to final commercial
